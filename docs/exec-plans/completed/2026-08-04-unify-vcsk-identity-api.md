...
Make CARLA Sensor Data Lake the canonical identity across the shipped web app,
...
The web app and local API now ship under the CARLA Sensor Data Lake identity.
