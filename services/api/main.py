...
API_TITLE = "CARLA Sensor Data Lake API"
API_DESCRIPTION = (
    "Local API for CARLA Sensor Data Lake: manage CARLA scenario configs, drive "
    "the simulator, and browse and serve the resulting multi-sensor driving "
    "datasets (RGB, segmentation, depth, LiDAR, telemetry) stored in Backblaze "
    "B2 over the S3-compatible API. This contract documents the app's local API, "
    "not a hosted public endpoint."
)
API_VERSION = "0.1.0"
...
app.include_router(lake.router, tags=["lake"])
