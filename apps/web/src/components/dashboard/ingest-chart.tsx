  ...
  return (
    <Card>
      <CardHeader className="border-b border-border py-4 px-5">
        <CardTitle className="card-title">Ingest Throughput</CardTitle>
        <CardDescription className="text-xs">
          Sensor frames written to B2, last 7 days
        </CardDescription>
      ...
      <CardContent className="p-5">
        {isLoading ? (
          ...
          <EmptyState
            icon={BarChart3}
            title="No ingest yet"
            description="Run a scenario to stream sensor frames into the lake."
          />
        ) : (
